...
>>> from ftwpki.baselibs.cli_parser import ServerClientCSRParser_DEV, ServerClientCSRProtocol

>>> from ftwpki.baselibs.configuration import BasePKIConfig_DEV
...
>>> ca_parser: ServerClientCSRParser_DEV = ServerClientCSRParser_DEV()
...
Namespace(countryName='DE', 
    ...
    dnsubject={'countryName': 'DE', 
        ...
        'localityName': 'Hamburg', 
        'organizationalUnitName': 'Infrastruktur und Dienste'}, 
    conf_file=PosixPath('member_server.toml'), 
    key_name='mem-serv', 
